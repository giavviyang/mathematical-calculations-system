...
public class TokenService implements TokenApi {
    ...
    @Autowired
    private DataStoreWrapper dataStoreService;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            LoginUser user = dataStoreService.getCacheObject(userKey);
            if (user == null) {
                throw new FuDianException(ExceptionEnum.LOGIN_TIMEOUT);
            }
            return user;
        }
        return null;
    ...
    public void setLoginUser(LoginUser loginUser) {
        if (StringUtils.isNotNull(loginUser) && StringUtils.isNotEmpty(loginUser.getToken())) {
            ...
            dataStoreService.setCacheObject(userKey, loginUser);
        }
    }
    ...
    public void delLoginUser(String token) {
        if (StringUtils.isNotEmpty(token)) {
            ...
            dataStoreService.deleteObject(userKey);
        }
    }
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        // 根据uuid将loginUser缓存
        String userKey = getTokenKey(loginUser.getToken());
        dataStoreService.setCacheObject(userKey, loginUser, expireTime, TimeUnit.MINUTES);
    }
