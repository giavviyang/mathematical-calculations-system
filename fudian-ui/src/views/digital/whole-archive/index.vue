        ...
        <el-col :span="24" :xs="24" style="padding: 10px;margin: 0;height: calc(100vh - 86px);">
          <el-row ref="searchRow" :gutter="10" style="margin:0 0 10px 0;padding-left: 0px">
            ...
            <el-form
              ...
              class="search-form"
            >
              <el-form-item label="创建人" label-width="68px" prop="createName" style="margin-top: 10px;margin-bottom: 10px">
                <el-input v-model="queryParams.createName" placeholder="请输入创建人姓名" @keyup.enter.native="onEnterSearch" clearable size="mini" style="width: 150px" />
              </el-form-item>
              <el-form-item label="创建时间起" prop="startTime" style="margin-top: 10px;margin-bottom: 10px">
                <el-date-picker v-model="queryParams.beginTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择创建起始时间" size="mini" style="width:150px"/>
              </el-form-item>
              <el-form-item label="创建时间至" prop="endTime" style="margin-top: 10px;margin-bottom: 10px">
                <el-date-picker v-model="queryParams.endTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择创建截止时间" size="mini" style="width:150px"/>
              </el-form-item>
            ...
            <div class="btn">
              ...
              <el-button type="primary" icon="el-icon-download" size="mini" v-hasPermi="['digital:whole-archive:import']" @click="handleExport">导出</el-button>
      ...
      <el-tab-pane label="已完成" name="completed">
        <el-col :span="24" :xs="24" style="padding: 10px;margin: 0;height: calc(100vh - 86px);">
          <el-row ref="searchRow2" :gutter="10" style="margin:0 0 10px 0;padding-left: 0px">
            ...
            >
              <el-form-item label="创建人" label-width="68px" prop="createName" style="margin-top: 10px;margin-bottom: 10px">
                <el-input v-model="queryParams2.createName" placeholder="请输入创建人姓名" @keyup.enter.native="onEnterSearch" clearable size="mini" style="width: 150px" />
              </el-form-item>
              <el-form-item label="创建时间起" prop="startTime" style="margin-top: 10px;margin-bottom: 10px">
                <el-date-picker v-model="queryParams2.beginTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择创建起始时间" size="mini" style="width:150px"/>
              </el-form-item>
              <el-form-item label="创建时间至" prop="endTime" style="margin-top: 10px;margin-bottom: 10px">
                <el-date-picker v-model="queryParams2.endTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择创建截止时间" size="mini" style="width:150px"/>
              </el-form-item>
              <el-form-item style="margin-top: 10px;margin-bottom: 10px">
                <el-button type="primary" icon="el-icon-search" size="mini" @click="queryTask">搜索</el-button>
                <!-- <el-button icon="el-icon-refresh" size="mini" @click="reset">重置</el-button> -->
...
<!--        <el-table-column align="center" label="编号" prop="number" :resizable="false" show-overflow-tooltip></el-table-column>-->
<!--        <el-table-column align="center" label="出生日期" prop="a0107" :resizable="false" show-overflow-tooltip width="100" ></el-table-column>-->
        <el-table-column align="center" label="材料分类" prop="full_name" :resizable="false" show-overflow-tooltip width="170" ></el-table-column>
        <el-table-column align="center" label="材料名称" prop="e01z111a" :resizable="false" show-overflow-tooltip width="170" ></el-table-column>
        <el-table-column align="center" label="材料制成日期" prop="e01z117" :resizable="false" show-overflow-tooltip width="100"></el-table-column>
        <el-table-column align="center" label="页数" prop="e01z114" :resizable="false" width="50"></el-table-column>
        <el-table-column align="center" label="备注" prop="e01z121" :resizable="false" show-overflow-tooltip ></el-table-column>
...
<script>
  import { queryTaskList,okTask,deleteTaskByIds,queryE01z1sByTaskId,deleteTaskE01z1ByTaskId } from '@/api/digital/scattered'
    ...
    data() {
      return {
        ...
        pendingColumn: [
          ...
          { label: '干部名称', prop: 'a0101', isCol: true },
          { label: '干部编号', prop: 'number', isCol: true },
          { label: '性别', prop: 'a0104', isCol: true },
          { label: '出生日期', prop: 'a0107', isCol: true },
        ],
        completedColumn:[
          { label: 'id', prop: 'id', isCol: false },
          { label: '创建人', prop: 'createName', isCol: true },
