...
export default {
  data() {
    return {
      ...
      col: [
        { label: '序号', prop: 'index', isCol: true },
        ...
        { label: '库房基本配置', prop: 'name1', isCol: true },
        { label: '灭火设施检查', prop: 'name2', isCol: true },
        { label: '防尘检查', prop: 'name3', isCol: true },
        { label: '防蛀检查', prop: 'name4', isCol: true },
        { label: '通风情况', prop: 'name5', isCol: true },
        { label: '线路设置', prop: 'name6', isCol: true },
        { label: '易燃易爆品防护', prop: 'name7', isCol: true },
        { label: '备注', prop: 'name8', isCol: true }
      ],
      tableData: [
        {
          index: '1',
