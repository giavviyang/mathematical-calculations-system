...
<script>
  ...
  import {upDataParams,printImgPdfBy,queryImgInfoByE01z1Id,download,downloadFile,updateE01z1,queryId} from '@/api/usually/daily/materials'
  // 获取当前网站端口
  ...
  export default {
    ...
    created() {
      ...
      body.setAttribute("oncontextmenu","self.event.returnValue=false");
    },
    methods: {
      //  给 iframe 传参
      sendMessage ( num ) {
      ...
      materialName(data){
        ...
        this.formElectronicFile = {
          ...
          e01z117Day:data.day,
          e01z117Month:data.month,
          e01z117Year:data.year,
