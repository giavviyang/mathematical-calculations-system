          ...
          <el-tab-pane label="学生分析" name="first">
            <slot-table class="mainCenter"
              ...
              <el-table
                ...
                @sort-change="changeSort" :cell-class-name="cellClsNm" :header-cell-class-name="headerName">
                <el-table-column
                  type="index"
                  label="排名"
                  width="50">
                ...
                <el-table-column prop="wrongQuestion" label="查看错题" width="200">
                  <template slot-scope="scope">
          ...
          <el-tab-pane label="知识点分析" name="second" class="klgTab">
            ...
            <slot-table class="mainCenter"
              ...
              <el-table border
                ...
                <el-table-column prop="errorTopics" label="查看错题" width="200">
                  <template slot-scope="scope">
        ...
        if (response.code === 200) {
          ...
          if (this.tableData) {
            this.tableData.forEach(item => {
              // console.log(item.wrongQuestion)
              if (item.wrongQuestion) {
                let arr = item.wrongQuestion.split(',');
                let arrForm = item.wrongQuestion.split(',');
                let str = '';
                let strForm = '';
                if (arr.length > 5) {
                  arr = arr.splice(0, 5);
        ...
        if (response.code === 200) {
          ...
          if (this.classifyData) {
            this.classifyData.forEach(item => {
              if (item.errorTopic) {
                let arr = item.errorTopic.split(',');
                let arrForm = item.errorTopic.split(',');
                let str = '';
                let strForm = '';
                if (arr.length > 5) {
                  arr = arr.splice(0, 5);
