  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        col: [
          {label: '运算方式', prop: 'userName', isCol: true},
          {label: '数域', prop: 'userNumber', isCol: true},
          {label: '数位处理方式', prop: 'loginCode', isCol: true},
          {label: '备注', prop: 'deptId', isCol: true, formatter: this.getFullName},
        ],
