package com.fudian.framework.manager.factory;
...
import com.fudian.common.utils.LogUtils;
...
//                logininfor.setLoginLocation(address);
                ...
                // 插入数据
                SpringUtils.getBean(SysLogininfoApi.class).save(logininfor);
            }
        };
    }
...
//                operLog.setOperLocation(AddressUtils.getRealAddressByIP(operLog.getOperIp()));
                ...
                SpringUtils.getBean(SysOperLogApi.class).save(operLog);
            }
        };
    }
}
